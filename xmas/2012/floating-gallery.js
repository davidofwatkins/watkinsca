...
function startSlideshow() {
    ...
    try {
        ...
        Console.log('HTML5 player not working');
    }
...
function animateNextGalleryItem(picturesset, captionPath, length) {
    ...
    if (picsrc != '') {
        ...
        image.load(function () {
            //need to "load" the image before finding its width/height
            if (imageLoaded == false) {
                ...
                if (imageWidth <= imageHeight) {
                    ...
                    //Caption
                    if (galleryItem.children('.fg-caption').length == 0) {
                        //If the caption does not already exist
                        galleryItem.append(
                            '<div class="fg-caption"><img src="' +
                                captionPath +
                                '" style="width: 100%; max-height: 100%; margin-top: 20%;" /></div>'
                        );
                    ...
                    if (galleryItem.children('.fg-caption').length == 0) {
                        //If the caption does not already exist
                        galleryItem.append(
                            '<div class="fg-caption"><img src="' + captionPath + '" style="width: 100%;" /></div>'
                        );
                    ...
                    galleryItem
                        ...
                        .load(function () {
                            galleryItem.height(
                                image.height() + galleryItem.children('.fg-caption').children('img').height()
                            );
                            startAnimation(galleryItem, length, targetLeft, targetTop);
                        });
                }
...
function getRandom(lowest, largest) {
    //(Inclusive)
