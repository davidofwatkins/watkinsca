...
var slides = new Array(
	//Snowy Champlain
	new Array("Champlain College", "binks-hotchocolate-snow.jpg", "snowy-champlain.jpg", "antigone-cover.jpg", "snowy-walkway.jpg"),
	//KKD 1a
	new Array("Marks Winter Visit", "Disney-Kayla-Mary-Mickey's-table.jpg", "Crescent-Beach.jpg", "karen-dad1.jpg", "Legoland-Mary-Dave.jpg"),
	//KKD 1b
	...
	//Bogie 2
	new Array("Bogie Out", "binks-pushing-bogie.jpg", "bogie-tongue.jpg", "karen-kayla-walking.jpg", "binks-walking-bogie.jpg"),
	//KKD 2a
	new Array("Marks Summer Visit", "kayla-bogie.jpg", "kayla-binks-bogie-car.jpg", "dad-karen2.jpg", "dinner-at-bay.jpg"),
	//KKD 2b (Beach)
	...
	//Gram's Birthday
	new Array("Jean's Birthday", "riviera.jpg", "binks-playing-guitar-for-family.jpg", "binks-diana.jpg", "mom-sally-gram-brucie.jpg"),
	//Gram
	...
	//Montreal 4
	new Array("^", "old-port-statue1.jpg", "notre-dame-day.jpg", "old-port-cirque-du-soleil.jpg", "old-port-statue2.jpg"),
	//Montreal 5
	...
	//Gram Support
	new Array("Support for Jean", "gram-joanie-babs.jpg", "ahernswithgram.jpg", "marta-visit-gram.jpg", "sallygramwhites.jpg"),
	//MD Visit
	new Array("David &amp; Kids", "dad-md2.jpg", "dadkaylathanksgiving.jpg", "dad-reading-to-kayla.jpg", "dad-md1.jpg"),
	//Bogie Support
	new Array("Support for Bogie", "gram-with-bogie.jpg", "lamiece-bogie.jpg", "bogie-jacuzzi.jpg", "bogie-and-buffy.jpg"),
	//Montreal Xmas 1
	new Array("Christmas is Coming", "lanterns.jpg", "roommate-hats.jpg", "Eaton-Xmas-Decorations.jpg", "fountains.jpg"),
	//Montreal Xmas 2
	...
	//Closing
	new Array('The End <small style="font-size: 14px;">(<a href="index.html">Replay</a>)</small>', "closinga.jpg", "closingb.jpg", "closingc.jpg", "closingd.jpg")
);
...
function preloadImages(arrayOfImages) {
    ...
    $(arrayOfImages).each(function(){ //Will take callback
