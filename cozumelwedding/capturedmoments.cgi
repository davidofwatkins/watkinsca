...
if ($quality eq "low") {
  $videoURL = "capturedmoments480p.mp4";
  $videoSize = "100 MB";
  $changeQuality = '<a href="capturedmoments.cgi?quality=high" style="font-size: 14px;">View in higher quality</a>';
}
elsif ($quality eq "high") {
  $videoURL = "capturedmoments720p.mp4";
  $videoSize = "458 MB";
  $changeQuality = '<a href="capturedmoments.cgi?quality=low" style="font-size: 14px;">View in lower quality</a>';
}

#construct the "change to HTML5" buttons depending on the setting
my $changeHTML5;
if ($html5 eq "on") {
  $changeHTML5 = '<a href="capturedmoments.cgi?html5=off" style="font-size: 14px;">Turn HTML5 Off</a>';
}
else {
  $changeHTML5 = '<a href="capturedmoments.cgi?html5=on" style="font-size: 14px;">Turn HTML5 On</a>';
}
...
print <<_endhtml_;
    ...
    <h1 font="google">Captured Moments</h1>
...
if ($quality ne "high" && $quality ne "low") {
  print <<_endhtml_;
		  ...
		  <a href="capturedmoments.cgi?quality=high"><div class="button">High Quality</div></a>
		  <a href="capturedmoments.cgi?quality=low"><div class="button">Standard Quality</div></a>
...
_endhtml_
  ...
  print <<_endhtml_;
		  <a 
			...
			id="player"><img src="capturedmomentsimg.jpg" alt="Click to Play" width="853" height="480" />
		  </a>
...
print <<_endhtml_;
    ...
    <div class="bottommeta" $commentsMargin>
	    ...
	    <!-- Include the Google Friend Connect javascript library. -->
			      <script type="text/javascript" src="http://www.google.com/friendconnect/script/friendconnect.js"></script>
		  <!-- Define the div tag where the gadget will be inserted. -->
		  <div id="div-8461769526429125514" style="width:720px;border:1px solid #333333;"></div>
		  <!-- Render the gadget into a div. -->
		  <script type="text/javascript">
		  var skin = {};
		  ...
		  google.friendconnect.container.renderWallGadget(
		   { id: 'div-8461769526429125514',
		     site: '14613135991466124949',
		     'view-params':{"disableMinMax":"false","scope":"ID","allowAnonymousPost":"true","features":"video,comment","docId":"Captured Moments","startMaximized":"true"}
		   },
		    skin);
		  </script>
      </center>    
